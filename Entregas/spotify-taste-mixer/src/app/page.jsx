...
import { getSpotifyAuthUrl } from '@/lib/auth' // Función para obtener URL de autenticación de Spotify
      ...
      <main className="flex flex-col items-center justify-center text-center px-4">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl">
          <div className="card hover-glow">
            <h3 className="text-lg font-semibold mb-2 text-primary-color">Elige Artistas o Canciones en detalle</h3>
            <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Selecciona tus artistas y canciones favoritas para generar playlists</p>
          </div>
          <div className="card hover-glow">
            <h3 className="text-lg font-semibold mb-2 text-accent-color">Utiliza widgets para generar tu playlist de forma automática</h3>
